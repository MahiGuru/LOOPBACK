                ...
                _.forEach(categorys, function(category, index) {
                    if (category.sectionCode == "STARTER" && category.categoryID == "VEG") {
                        ...
                        _.forEach(vegStarterItems, function(vegStarter, key) {
                            itemModel.create([
                                { "itemID": "CATE_ITEM_" + category.categoryID + "_0" + index, "name": vegStarter, "description": vegStarter, "price": 100 * key, "categoriesId": category.id, status: "0" }
                            ]);
                        });
                        ...
                        _.forEach(nonvegStarterItems, function(nonvegStarter, key) {
                            itemModel.create([
                                { "itemID": "CATE_ITEM_" + category.categoryID + "_0" + index, "name": nonvegStarter, "description": nonvegStarter, "price": 100 * key, "categoriesId": category.id, status: "0" }
                            ]);
                        });
                        ...
                        _.forEach(vegSoupsItems, function(vegSoup, key) {
                            itemModel.create([
                                { "itemID": "CATE_ITEM_" + category.categoryID + "_0" + index, "name": vegSoup, "description": vegSoup, "price": 100 * (key + 1), "categoriesId": category.id, status: "0" }
                            ]);
                        });
                        ...
                        _.forEach(nonvegSoupsItems, function(nonvegSoup, key) {
                            itemModel.create([
                                { "itemID": "CATE_ITEM_" + category.categoryID + "_0" + index, "name": nonvegSoup, "description": nonvegSoup, "price": 100 * (key + 1), "categoriesId": category.id, status: "0" }
                            ]);
                        });
                        ...
                        _.forEach(vegSaladsItems, function(vegSalad, key) {
                            itemModel.create([
                                { "itemID": "CATE_ITEM_" + category.categoryID + "_0" + index, "name": vegSalad, "description": vegSalad, "price": 100 * (key + 1), "categoriesId": category.id, status: "0" }
                            ]);
                        });
                        ...
                        _.forEach(nonvegSaladItems, function(nonVegSalad, key) {
                            itemModel.create([
                                { "itemID": "CATE_ITEM_" + category.categoryID + "_0" + index, "name": nonVegSalad, "description": nonVegSalad, "price": 100 * (key + 1), "categoriesId": category.id, status: "0" }
                            ]);
                        });
                        ...
                        _.forEach(vegMainCourseItems, function(vegMain, key) {
                            itemModel.create([
                                { "itemID": "CATE_ITEM_" + category.categoryID + "_0" + index, "name": vegMain, "description": vegMain, "price": 100 * (key + 1), "categoriesId": category.id, status: "0" }
                            ]);
                        });
                        ...
                        _.forEach(nonvegMainCourseItems, function(nonvegMain, key) {
                            itemModel.create([
                                { "itemID": "CATE_ITEM_" + category.categoryID + "_0" + index, "name": nonvegMain, "description": nonvegMain, "price": 100 * (key + 1), "categoriesId": category.id, status: "0" }
                            ]);
                        });
                    }
